...
--
-- Demande Christelle sur Tipote (2 août 2026), portée ici : "je voudrais
-- que les infos complétées pour générer un contenu soient persistantes,
-- pour ne pas avoir à tout réécrire quand je veux rédiger un mail, un
-- post et un article sur le même thème."
--
-- Une ligne par (utilisateur, scope). Un seul scope ici, 'affiliate'
-- (l'atelier d'écriture de l'espace affiliation). La colonne existe pour
-- que le jour où un deuxième générateur apparaît, il n'écrase pas le
-- brief du premier.
--
