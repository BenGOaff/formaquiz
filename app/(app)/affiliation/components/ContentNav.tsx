// Fil d'Ariane + carte de dossier de l'espace Contenu. Même grammaire que
// "Mes projets" côté Tiquiz, et même rendu que l'espace affilié de Tipote :
// on descend dans des dossiers, on remonte par le fil d'Ariane.
//
...
// Marquée côté client, la même carte faisait planter /contenus en
// production chez Tipote sur "An error occurred in the Server Components
// render" (1er août 2026), sans message utile et sans que le typecheck ne
// voie quoi que ce soit. Si un jour ce fichier a besoin d'interactivité,
// isoler la partie interactive dans un composant client dédié plutôt que
// de marquer tout le fichier.
      ...
      >
        <CardContent className="flex h-full flex-col gap-3 py-5">
          <div className="flex items-start justify-between gap-3">
            ...
            {badge && (
              <Badge variant={highlight ? "default" : "secondary"} className="px-2.5 text-sm">
                {badge}
              </Badge>
            )}
          </div>
