...
//
// Jusqu'ici, une affiliée envoyait vers `tipote.fr/atelier-du-quiz`, un
...
// atelierduquiz.fr n'est payée sur rien.** Elle n'a aucun moyen de le
...
// `lib/affiliateTracking.ts` sur les conversions par email
