// lib/affiliateContent/posts.ts
//
// Posts réseaux du kit affilié de l'Atelier du Quiz. Généré depuis le
// markdown source (vente/contenu-affiliés) : ne pas réécrire à la main,
// régénérer si le kit évolue.
//
// SOURCE PARTAGÉE avec l'espace affilié de Tipote
// (app/affiliate/promouvoir/content/atelier-posts-fr.ts). Les deux
// fichiers doivent rester identiques, visuels compris : les images sont
// servies au MÊME chemin public dans les deux apps
// (/affiliate-assets/atelier/posts/...).
//
...
export const ATELIER_POSTS: AtelierPost[] = [
  {
    "id": "atelier-post-01",
    "label": "L'ouverture",
