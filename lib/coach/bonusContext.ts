...
const HOSTING: Record<BonusShape, string> = {
  ...
  page: "le fichier HTML est collé dans un bloc de code d'une page Systeme.io qui ACCEPTE le code (une page de blog, ou une page de remerciement dans un tunnel : une page info n'en accepte pas), qu'il publie et dont il copie l'adresse. Et le code colle est un MORCEAU de page : jamais de <head> ni de <body>",
  acces:
