...
const HOSTING: Record<BonusShape, string> = {
  ...
  page: "le fichier HTML est collé dans un bloc de code d'une page Systeme.io (page de blog ou de tunnel), qu'il publie et dont il copie l'adresse",
  acces:
