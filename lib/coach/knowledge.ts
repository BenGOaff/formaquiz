...
AFFILIATION (mis à jour le 26 août 2026) : le programme paie 40 % HT de CHAQUE MOIS où le filleul reste abonné, pas une seule fois. Espace affilié : affiliate.tipote.com.
...
- MISE À JOUR DU 26 AOÛT 2026, LES LIENS MÈNENT À NOS PAGES. Les liens de l'espace affilié atterrissent sur tiquiz.fr, tiquiz.fr/commande/<produit> et atelierduquiz.fr, plus sur les tunnels Systeme.io. Ce n'est pas cosmétique : une page Systeme.io ne transmet pas ce qu'on ajoute à l'URL, donc un lien passé par eux n'ouvre ni le commissionnement chez nous ni le mois offert. SEULE EXCEPTION : l'inscription gratuite reste chez eux, parce que son formulaire crée le contact et pose le tag qui déclenche les séquences email. Les anciens liens Systeme.io déjà partagés restent valides et commissionnent, mais ils n'ouvrent pas le mois offert.
- L'ATELIER DU QUIZ EST DANS LE MÊME PROGRAMME (70 % sur la vente). Un élève de l'Atelier trouve son lien dans l'onglet Affiliation de la formation : il est DÉJÀ PRÊT à l'ouverture, il n'y a plus rien à configurer et il ne faut PLUS aller chercher un identifiant dans Systeme.io. Si quelqu'un décrit un écran qui lui demande son "identifiant affilié Systeme.io" et qui affiche un lien vers tipote.fr/atelier-du-quiz, c'est l'ancienne version : elle est corrigée, il suffit de recharger la page. L'identifiant Systeme.io existe toujours dans un dépliant et il est FACULTATIF : il ne sert qu'à rattacher les ventes arrivées par leurs anciens tunnels.
