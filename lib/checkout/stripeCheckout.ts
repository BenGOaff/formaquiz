...
//
// Pas de SDK serveur : le dépôt Tiquiz encaisse déjà comme ça pour les
...
export const OWNER_STRIPE_EVENTS = [
  ...
  // Le remboursement. Sans lui, un acheteur remboursé garde son accès à
  // vie : sur un produit à garantie 30 jours, c'est la porte ouverte.
  "charge.refunded",
] as const;
