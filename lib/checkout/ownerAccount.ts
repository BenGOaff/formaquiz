...
//
// Ce sont NOS secrets, donc ils vivent là où vivent tous les autres,
// dans le `.env` du serveur. (Côté Tiquiz, ceux d'un REVENDEUR vivent
// en base et chiffrés, parce que ce sont les secrets de quelqu'un
// d'autre : ce module est le jumeau de celui de Tiquiz, ne pas les
// laisser diverger.)
//
