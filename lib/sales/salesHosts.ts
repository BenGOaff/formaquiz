...
//
// Chantier du 20 août : `atelierduquiz.fr` sert la page de vente et le bon de
...
// ouverte, sinon le domaine ne sert à rien. Sur `quizing.tipote.com`, elle
...
export const PUBLIC_SALES_CANONICAL: Readonly<Record<string, string>> = {
  "atelier-du-quiz": "https://atelierduquiz.fr/",
};
 ...
 * était construite depuis `APP_URL`, donc `quizing.tipote.com`. Un
 * acheteur venu de `atelierduquiz.fr` n'a AUCUNE clé dans son URL
