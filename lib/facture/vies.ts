...
//
// PORTÉ DEPUIS TIQUIZ LE 31 AOÛT 2026. Il y vivait depuis le 27, et
// l'Atelier avait gardé la validation de FORME seule : un numéro bien
// formé mais inexistant y produisait encore une autoliquidation
// injustifiée. Un garde-fou qui ne protège qu'un des deux jumeaux ne
// protège personne, et ici c'est le panier le plus gros qui restait
// découvert.
//
...
//
// Oui, et l'enjeu est chiffrable : sur une vente de l'Atelier à 47 € en
// autoliquidation injustifiée, ce sont 7,83 € de TVA qu'elle paie de sa
// poche, découverts au contrôle, plusieurs années plus tard, avec des
// pénalités. Et depuis le 31 août, une TVA fautivement à zéro fait AUSSI
// commissionner l'affilié sur le TTC : 70 % de 47 € au lieu de 70 % de
// 39,17 €, soit 5,48 € de trop. La même erreur coûte deux fois. La forme d'un numéro ne prouve rien : `BE0123456789` est
