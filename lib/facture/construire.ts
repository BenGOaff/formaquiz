...
/**
 * "AQ-2026". Le préfixe ne bouge jamais : il est dans le numéro émis.
 *
 * **IL DIFFÈRE DE CELUI DE TIQUIZ (`TQ`), ET C'EST OBLIGATOIRE.** Les
 * deux apps ont leur propre base et leur propre compteur : avec le même
 * préfixe, elles émettraient chacune un `TQ-2026-0001` pour deux ventes
 * différentes. Deux factures au même numéro, c'est le défaut le plus
 * simple à repérer dans un contrôle.
 *
 * Une société PEUT tenir plusieurs séries, à condition que chacune soit
 * continue : une par produit est un découpage courant et défendable.
 */
export const PREFIXE_SERIE = "AQ";
