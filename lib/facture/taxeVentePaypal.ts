...
//
// L'Atelier paie 70 %. Sur une vente à 47 € avec 20 % de TVA, c'est
// 32,90 € au lieu de 27,42 € : **5,48 € de trop par vente**, et un
// affilié payé différemment selon que son acheteur a sorti une carte ou
// un compte PayPal.
//
// Ces deux chiffres sont exactement ceux du drame du 19 août : l'app
// annonçait 32,90 € et payait 27,42 €. On avait corrigé ce que l'app
// ANNONCE ; le chemin PayPal, lui, versait encore les 32,90 €.
//
...
//
// Jumeau de `lib/facture/taxeVentePaypal.ts` chez Tiquiz : toute
